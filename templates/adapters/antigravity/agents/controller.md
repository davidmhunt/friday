...
2. `.friday/active/harness/roles/controller.md` — this role's namespace, constraints, and
   handoff protocol.
...
writes) are documented in `.friday/active/harness/rules/conventions.md` §Honest caveat on
tool enforcement.
