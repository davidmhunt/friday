...
into `.friday/active/harness/`, never edit `.friday/active/harness/` itself for a tool-specific reason.
...
- **Path-scope writes.** "Planner writes only `.friday/active/harness/plans/`", "Author
