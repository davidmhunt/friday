...
docs/references/needs_pdf.md (see .friday/active/harness/roles/researcher.md "Tooling").
...
Usage:
    python3 .friday/active/harness/tools/find_open_access_pdf.py            # all entries missing a PDF
    python3 .friday/active/harness/tools/find_open_access_pdf.py somekey ... # just these keys
