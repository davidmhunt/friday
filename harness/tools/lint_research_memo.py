#!/usr/bin/env python3
"""Structural + Sources-format check for harness/research/*.md memos.

Run by the Reviewer alongside verify_references.py whenever the Researcher
produced or edited a memo this cycle (harness/roles/reviewer.md "Pass
protocol" step 5). Checks each memo against the shape defined in
harness/templates/research_memo_template.md:
